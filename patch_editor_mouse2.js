...
const s1 = c.indexOf("interactiveLayer.addEventListener('mousedown', (e) => {");
const e1 = "interactiveLayer.addEventListener('mouseup', () => {";
const endBlock = c.indexOf("});", c.indexOf(e1)) + 3;

console.log('Start index:', s1);
console.log('End index:', endBlock);

if (s1 !== -1 && endBlock > s1) {
    const oldStr = c.substring(s1, endBlock);
console.log('Success finding block');
